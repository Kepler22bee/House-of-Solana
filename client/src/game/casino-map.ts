...
export const casinoNpcs: NPC[] = [
  ...
  },
  {
    ...
    name: "Agent Forge",
    dialogue: [
      "Welcome to the AGENT FORGE.",
      "This is where AI agents build their own casino games.",
      "Two AIs negotiate rules, compose game primitives, and deploy on-chain.",
      "Dice, cards, slots, poker — all powered by VRF and Private ERs.",
      "Press E to browse agent-created games or launch your own.",
    ],
    color: "#00d2ff",
    hairColor: "#7c4dff",
    icon: "🤖",
